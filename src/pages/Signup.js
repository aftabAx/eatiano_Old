...
const Signup = () => {
  ...
  const register = async (e) => {
    ...
    const response = await axios.post(
      'https://achievexsolutions.com/eatiano_backend/public/index.php/api/auth/signup',
      {
      ...
      <div className='relative py-8 lg:bg-no-repeat lg:bg-center lg:bg-signup md:py-12 lg:py-16'>
        ...
        <div className='container relative flex items-center justify-center lg:justify-end '>
          ...
          <form onSubmit={register}>
            ...
            <button
              type='submit'
              className=' login-button w-full px-8 py-2 text-lg font-medium text-gray-900 transition-all duration-300 rounded-lg mb-7 md:mb-12 hover:text bg-cta md:text-xl hover:bg-cta-dark hover:scale-110 focus:ring-2 ring-offset-2 ring-cta-dark'
            >
              Signup
            </button>
